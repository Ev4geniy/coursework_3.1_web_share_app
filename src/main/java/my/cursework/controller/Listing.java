...
public class Listing extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("views/mainPage.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (dir == null || dir.isEmpty()){
            dir = "/" + username + "/";
            //dir=(String)request.getSession().getAttribute("username");
        }
        ...
        for (String it : splitPath){
            if(!it.equals("/") && !it.isEmpty()){
                ...
                System.out.println("CREATEPARSE: " + it);
            }
        }
...
//            pw.println(target.printContent(0));
            }
        }
