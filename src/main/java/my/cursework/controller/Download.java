...
//        for (String it: filename.split("/")){
//            if(!it.equals("/") && !it.isEmpty()){
//                target = target.getChild(it);
//                System.out.println("DOWNLOAD:DOGET:PATHCHECK "+it);
//            }
//        }

        //System.out.println("FULLPATH: "+fullPath);
        //File file = new File(fileUploadPath+target.getFullName());
        //if (file == null) System.out.println("DOWNLOAD:DOGET:file not found:"+fileUploadPath+target.getFullName());
